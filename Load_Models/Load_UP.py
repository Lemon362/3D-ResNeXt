...
for index_iter in range(ITER):
    ...
    best_weights_ResNeXt_path = 'D:/3D-ResNeXt-master/models/UP_best_3D_ResNeXt_5_1_4_60_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats_assess(KAPPA_3D_ResNeXt, OA_3D_ResNeXt, AA_3D_ResNeXt, ELEMENT_ACC_3D_ResNeXt,
                                    CATEGORY,
                                    'D:/3D-ResNeXt-master/records/UP_test_3D_ResNeXt_4_1_5_60_1.txt',
