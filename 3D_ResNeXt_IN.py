...
def model():
    model = ResneXt_IN_Dual_Network.ResneXt_IN((1, img_rows, img_cols, img_channels), classes=16)
    ...
    model.summary()
    plot_model(model, show_shapes=True, to_file='./model_3D_ResNeXt_IN.png')
...
for index_iter in range(ITER):
    ...
    best_weights_ResNeXt_path = './models/IN_best_3D_ResNeXt_5_1_4_60_' + str(index_iter + 1) + '.hdf5'
    ...
    # save loss_acc curve
    with open('./Loss_Acc/IN_label.hdf5', 'w') as f:
...
modelStatsRecord.outputStats(KAPPA_3D_ResNeXt, OA_3D_ResNeXt, AA_3D_ResNeXt, ELEMENT_ACC_3D_ResNeXt,
                             ...
                             './records/IN_train_3D_ResNeXt_5_1_4_60_1.txt',
                             './records/IN_train_element_3D_ResNeXt_5_1_4_60_1.txt')
